...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model_family', type=str, default='effort', choices=['effort', 'dinov3'])
        ...
        parser.add_argument(
            ...
            type=str,
            default='quality_bin',
            choices=['quality_bin', 'quality_soft', 'degrade_bin', 'uniform', 'router', 'hybrid', 'degrade_router', 'degrade_hybrid'],
        )
        ...
        # Inverse-MEv1: keep MEv1 behavior via teacher, but push adapters away from anchor ckpt.
        parser.add_argument('--inv_mev1_enable', action='store_true', default=False)
        parser.add_argument('--inv_mev1_anchor_ckpt', type=str, default=None)
        parser.add_argument('--inv_mev1_teacher_ckpt', type=str, default=None)
        parser.add_argument('--inv_mev1_div_lambda', type=float, default=0.0)
        parser.add_argument('--inv_mev1_div_target_cos', type=float, default=0.995)
        parser.add_argument('--inv_mev1_kd_lambda', type=float, default=0.0)
        parser.add_argument('--inv_mev1_kd_temp', type=float, default=2.0)
        parser.add_argument('--inv_mev1_teacher_every', type=int, default=1)
        parser.add_argument('--inv_mev1_warmup_steps', type=float, default=0.0)
        parser.add_argument('--inv_mev1_ramp_steps', type=float, default=0.0)
        parser.add_argument('--dino_source', type=str, default='timm', choices=['timm', 'torchhub'])
        parser.add_argument('--dino_repo', type=str, default='facebookresearch/dinov3')
        parser.add_argument('--dino_model_name', type=str, default='hf-hub:timm/convnext_base.dinov3_lvd1689m')
        parser.add_argument('--dino_pretrained', action='store_true', default=True)
        ...
        parser.add_argument('--dino_force_imagenet_norm', action='store_true', default=True)
        ...
        parser.add_argument(
            '--train_frame_sample_mode',
            type=str,
            default='uniform',
            choices=['uniform', 'random', 'uniform_randstart'],
        )
        parser.add_argument(
            '--val_frame_sample_mode',
            type=str,
            default='uniform',
            choices=['uniform', 'random', 'uniform_randstart'],
        )
        parser.add_argument('--frame_sample_seed', type=int, default=42)
        parser.add_argument('--train_frame_sample_seed', type=int, default=None)
        parser.add_argument('--val_frame_sample_seed', type=int, default=None)
        ...
        parser.add_argument('--stratified_sampler_key', type=str, default='stratum_id', choices=['stratum_id', 'quality_bin', 'degrade_bin'])
        ...
        parser.add_argument('--quality_clipiqa_device', type=str, default='cuda')
        ...
        parser.add_argument('--degrade_cache_train_path', type=str, default=None)
        parser.add_argument('--degrade_cache_val_path', type=str, default=None)
        ...
        parser.add_argument('--groupdro_group_key', type=str, default='quality_bin', choices=['quality_bin', 'stratum_id', 'degrade_bin'])
